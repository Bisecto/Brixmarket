...
List<GetPage<dynamic>> authPages = [
  ...
  GetPage(name: RouteStr.registerHome, page: () => const SignUpHomePage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.register, page: () => const RegisterPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.verityOtp, page: () => VerifyOtpPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.regBasic, page: () => const RegBasicInfoPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.regAgency, page: () => RegAgencyPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.recoverPassword, page: () => const ForgotPassword(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.verifyPasswordOTP, page: () => PasswordOtpPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.createNewPassword, page: () => const CreateNewPassword(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
];
...
List<GetPage<dynamic>> mobileHomePages = [
  GetPage(name: RouteStr.mobileHome, page: () => HomePage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(
      name: RouteStr.mobileNotification, page: () => const HomeNotificationsPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileHomeSearch, page: () => const HomeSearchPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileExplore, page: () => const ExplorePage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(
...
List<GetPage<dynamic>> mobileDashboardPages = [
  ...
  GetPage(name: RouteStr.mobileStatistic, page: () => const StatisticPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
...
List<GetPage<dynamic>> mobileProfilePages = [
  GetPage(
      name: RouteStr.mobilePersonalInfo, page: () => const PersonalInformation(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileAgencyInfo, page: () => const AgencyInformation(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileLegalDocumentInfo, page: () => const LocationInfo(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(
      name: RouteStr.mobileLocationInfo, page: () => const LegalDocumentation(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileMobileIdInfo, page: () => const IdentityDocument(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(
      name: RouteStr.mobileChangePassword, page: () => const ChangePasswordPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
];
...
List<GetPage<dynamic>> supportPages = [
  ...
  GetPage(name: RouteStr.mobileAbout, page: () => const AboutUsPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileFAQ, page: () => const FAQPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobilePolicy, page: () => const PolicyPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileTerms, page: () => const TermsPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileContact, page: () => const ContactPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
  GetPage(name: RouteStr.mobileSubPayment, page: () => SubScriptionPage(), transition: Transition.fadeIn, transitionDuration: const Duration(milliseconds: 500)),
];
