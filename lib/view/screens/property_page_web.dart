...
class _PropertyDetailsListsPageState extends State<PropertyPageWeb> {
  ...
  Widget build(BuildContext context) {
            ...
            return Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: CustomText(color: Colors.black54, text: feature.featureValue, weight: FontWeight.w500, size: 16, maxLines: 3)),
                ],
              ),
            );
          }).toList();
            ...
            return Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.check, color: Colors.black54, size: 18),
                  const SizedBox(width: 16),
                  Expanded(child: CustomText(color: Colors.black54, text: value.amenity, weight: FontWeight.w500, size: 16, maxLines: 3)),
                ],
              ),
            );
          }).toList();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: isMobile() ? 0 : mainPadding),
                  child: Row(
                    children: [
                      Expanded(
                        flex: 8,
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: mainPadding, vertical: 8),
                  width: Get.width,
                  child: Wrap(
                      ...
                      Wrap(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: CustomText(
                                      color: const Color(0xFF308b85), text: property.type!.toUpperCase(), weight: FontWeight.w500, size: isTabletDown() ? 12 : 14),
                                ),
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: CustomText(color: Colors.white, text: property.status!.toUpperCase(), weight: FontWeight.w500, size: isTabletDown() ? 12 : 14),
                                ),
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(Icons.calendar_month, color: Pallet.secondaryColor, size: 18),
                              const SizedBox(width: 5),
                              CustomText(
                      ...
                      InkWell(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const CustomText(color: Colors.black, text: 'Flag as inappropriate', weight: FontWeight.w500, size: 16),
                          ],
                        ),
                      )
                    ],
                ...
                Container(
                    margin: EdgeInsets.symmetric(horizontal: mainPadding, vertical: 24),
                    child: Wrap(
                      // crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        SizedBox(
                            width: isTabletDown() ? Get.width : Get.width * 0.58,
                            child: Container(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: CustomText(color: Colors.black, text: property.title, weight: FontWeight.bold, size: 25, maxLines: 3),
                                        ),
                                      ),
                                      isMobile()
                                          ? const SizedBox.shrink()
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: ReadMoreText(
                                          ...
                                          lessStyle: const TextStyle(fontSize: 13, fontWeight: FontWeight.w200, color: Pallet.secondaryColor),
                                          trimCollapsedText: '  Read more',
                                          trimExpandedText: '  Read less',
                                          moreStyle: const TextStyle(fontSize: 13, fontWeight: FontWeight.normal, color: Pallet.secondaryColor),
                                        ),
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          const CustomText(color: Colors.black, text: 'Property Details (Nearby)', weight: FontWeight.w800, size: 18),
                                        ],
                                      ),
                                      const SizedBox(
                                        height: 12,
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          const CustomText(color: Colors.black, text: 'Amenities', weight: FontWeight.w800, size: 18),
                                        ],
                                      ),
                                      const SizedBox(
                                        height: 12,
                                      ...
                                      Padding(padding: const EdgeInsets.only(left: 23.0), child: reviews),
                                      const SizedBox(
                                        height: 48,
                                      ),
                                      Row(
    ...
    ? const SizedBox.shrink()
        : const CustomText(color: Colors.black, text: 'Review this Property', weight: FontWeight.w800, size: 18),
                                          const SizedBox(
                                            width: 20,
                                          ),
                                        ],
                                          ...
                                          : Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  FormButton(
                                                    onPressed: () => propCtrl.submitPropertyReview(property.id),
                                                    text: 'Submit Review',
                                                    width: 160,
                                                    height: 42,
                                                    size: 16,
                        ...
                        SizedBox(
                            width: isTabletDown() ? Get.width : Get.width * 0.28,
                            child: Container(
                              // height: 1600,
                              padding: EdgeInsets.only(left: isTabletDown() ? 0 : 24, top: isTabletDown() ? 24 : 0),
                              child: Column(
                                  ...
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: const Center(
                                              child: CustomText(color: Colors.white, text: 'AGENT INFORMATION', weight: FontWeight.w700, size: 12),
                                            ),
                                          ),
                                          ...
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: FadeInImage(
                                                ...
                                                placeholder: const AssetImage(ImgStr.logo1),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                          ),
                                              ...
                                              : Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    CustomText(
                                                        underline: true,
                                                        color: Pallet.secondaryColor,
                                                        text: '${property.contact?.phoneNumber}',
                                                  ...
                                                  widget: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      CustomText(
                                                          underline: true,
                                                          color: Pallet.secondaryColor,
                                                          text: '${property.contact?.whatsAppNumber}',
                                                          weight: FontWeight.w700,
                                                          size: 11),
                                                    ],
                                                  ),
                                    ...
                                    user.id == property.user?.id
                                      ...
                                      child: property.user?.settings?.requestTourAlert.value == false
                                          ? const SizedBox.shrink()
                                          : Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8),
                                                      FormButton(
                                                        onPressed: () => propCtrl.submitRequestATour(property.id),
                                                        text: 'Send Request',
                                                        txtColor: Colors.white,
                                                        // width: do,
                                                        height: 42,
