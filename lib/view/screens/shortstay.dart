...
import '../../controllers/mixin/fetch_property_mixin.dart';
...
class Short_stay extends StatefulWidget {

  Short_stay({Key? key}) : super(key: key);

  @override
  State<Short_stay> createState() => _Short_stayState();
}

class _Short_stayState extends State<Short_stay> {
  final homeScaffoldKey = GlobalKey<ScaffoldState>();
@override
  void initState() {
    // TODO: implement initState
    super.initState();
    //FetchProperty.getPropertiesWeb();
  }
  @override
...
Widget buildListShort_stayContainer({required List<Property> properties}) {
