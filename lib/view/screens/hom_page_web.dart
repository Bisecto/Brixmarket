...
class _HomePageWebState extends State<HomePageWeb> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          index = 0;
                                          EditCtrl.propertyType.value = 'Buy';
                                        });
                                      },
                                ...
                                Expanded(
                                  child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          index = 2;
                                          EditCtrl.propertyType.value = 'Commercial';
                                ...
                                Expanded(
                                  child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          index = 3;
                                          EditCtrl.propertyType.value = 'ShortLet';
                ...
                (isMobile() || isTabletDown()) ? const SizedBox.shrink() : SizedBox(
               height: 600,
               child: Stack(children: [
                 SizedBox(
                   width: isTabletDown() ? Get.width : Get.width * 0.75,
                   child: Image.asset(
                    ...
                    builder: (context, AsyncSnapshot<List<Property>> snap) {
                      ...
                      return properties.isEmpty
                        ...
                        children: [
                          ...
                          GridView.builder(
                              itemCount: (properties.length < 6) ? properties.length:6,
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              padding:  EdgeInsets.symmetric(horizontal: (isMobile() || isTabletDown()) ? Get.width * 0.018:Get.width * 0.058),
                              gridDelegate:   SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: (isMobile() || isTabletDown()) ? 1 : 3,
                                mainAxisSpacing: 1,
                                crossAxisSpacing: 20,
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                var image = properties[index].media!.isNotEmpty
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    fit: BoxFit.cover,
                                                    image: NetworkImage(
                                                      propertyImgPath + '${properties[index].media![index].media}' ?? '',
                                                    ))),
                                          ),
  ...
  Widget boxContainer({String? title,
    String? subtitle,
    double? height,
    double? width,
    String? image}) {
