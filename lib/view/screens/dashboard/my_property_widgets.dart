...
class _MyPropertiesWidgetState extends State<MyPropertiesWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.tabController = widget.tabController ??
        TabController(length: 5, vsync: widget.provider);
...
Widget myPropertiesWidget(List<Property> myProperties) {
  return ListView.builder(
      ...
      itemBuilder: ((context, index) {
        print("This is me");
        print(myProperties[index].location?.address);
        print("This is me");
        ...
        if (images.isEmpty) {
          ...
          image = property.media!.first.media!;
        }
        return Column(
          children: [
            Padding(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Text(
                                              '${property.location?.state ?? property.description}, ${property.location?.city ?? ''}, ${property.location?.state ?? ''}',
                                              maxLines: 3,
                                              style: const TextStyle(
                                                color: Colors.black,
