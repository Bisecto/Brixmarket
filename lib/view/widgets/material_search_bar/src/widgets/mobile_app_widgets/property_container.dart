...
buildSavedList(
  ...
  String image =
  (property.media ?? []).isNotEmpty ? property.media[0].media: '';
  List<savedProperty.Media> images = property.media ?? [];
  return Container(
    width: 240,
    height: (showMore)
        ? 420
        ...
        children: [
                ...
                (showMore)
                  ...
                  child: Column(
                    children: [
                      CustomText(
                          color: Pallet.secondaryColor,
                          text: Utils.amount(property.data.price ?? 0),
                          weight: FontWeight.bold,
                          size: 18),
                      const SizedBox(height: 2),
                      property.data.priceDuration!.substring(0, 3) == 'Per'
                          ? CustomText(
                          color: Colors.blueGrey,
                          text: property.data.priceDuration!
                              .substring(0, 3) ==
                              'Per'
                              ? property.data.priceDuration!.toUpperCase()
                              : '',
                          weight: FontWeight.bold,
                          size: 12)
                          : const SizedBox.shrink(),
          ...
          Row(
            ...
            children: [
              ...
              Obx(() => SavePropertyIconSavedProperty(
                property: property,
                user: homeCtrl.user.value,
                state: homeCtrl.savingProperty.value,
                size: 22,
          ...
          (showMore)
            ...
            child: Row(
              children: [
                ...
                CustomText(
                    color: Colors.blueGrey,
                    text: property.data.priceDuration!.substring(0, 3) == 'Per'
                        ? property.data.priceDuration!.toUpperCase()
                        : '',
                    weight: FontWeight.bold,
                    size: 12),
