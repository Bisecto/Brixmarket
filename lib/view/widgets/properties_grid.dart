    ...
    return GridView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(border: Border.all(color: Colors.black.withOpacity(0.01)), borderRadius: BorderRadius.circular(4)),
            child: InkWell(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    width: 80,
                                    child: Center(
                                      child: CustomText(color: const Color(0xFF308b85), text: property.type!.toUpperCase(), weight: FontWeight.w500, size: 9),
                                    ),
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: CustomText(color: Colors.white, text: property.status!.toUpperCase(), weight: FontWeight.w500, size: 9),
                                    ),
                              ...
                              true
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        CustomText(color: Colors.black, text: (property.numberOfRatingUsers ?? '0').toString(), weight: FontWeight.w500, size: 9),
                                      ],
                                    ),
                            ],
                          ),
                          const SizedBox(height: 8),
                          CustomText(color: Colors.black, text: property.title, weight: FontWeight.w700, size: 16),
                          const SizedBox(
                            height: 8,
                          ),
                          Row(
                          ...
                          const CustomText(color: Colors.black, text: 'Price', weight: FontWeight.w300, size: 12),
                          const SizedBox(
                            height: 6,
                          ),
                          Row(
                            ...
                            children: [
                              ...
                              Obx(() => SavePropertyIcon(property: property, size: 15, user: homeCtrl.user.value, state: homeCtrl.savingProperty.value)),
                            ],
                          ),
                        ],
                      ),
