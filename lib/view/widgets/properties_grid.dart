...
class PropertiesWebGrade extends StatelessWidget {
  const PropertiesWebGrade({Key? key, required this.properties})
      : super(key: key);
  final List<filter.Property> properties;
...
class PropertyShortStayGrid extends StatelessWidget {
  const PropertyShortStayGrid({Key? key, required this.properties})
      : super(key: key);
  final List<Property> properties;
